...
import 'package:login_basic/utils/styles.dart';
import 'package:login_basic/utils/notification_dialog_box.dart';



class LoanScreen extends StatelessWidget {
  final VoidCallback voidCallback;
  LoanScreen({this.voidCallback});
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Loan Demo Home Page'),
    );
  }
}
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Row(
              ...
              crossAxisAlignment: CrossAxisAlignment.center,
              children: <Widget>[
                _menuItem('My\nOffers', FontAwesomeIcons.coins, yellowGradient),
    ...
    return Row(
      ...
      children: <Widget>[
        ...
        IconButton(
            ...
            icon: Icon(Icons.notification_important), iconSize: 30, color: Colors.blueGrey[700]),
      ],
    );
  }
}
